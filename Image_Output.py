...
parser.add_argument('--model', default='Sand_Dehazed/latest_model.pt', help='training directory')
parser.add_argument('--images', nargs='+', type=str, default='52.jpg', help='path to hazy folder')
